...
class FirestoreClient {
    ...
    constructor(opts) {
        ...
        const protos = merge({}, gaxGrpc.loadProto(path.join(__dirname, '..', '..', 'protos'), 'google/firestore/v1/firestore.proto'));
        ...
        const firestoreStub = gaxGrpc.createStub(protos.google.firestore.v1.Firestore, opts);
