...
class FirestoreAdminClient {
    ...
    constructor(opts) {
        ...
        const protos = merge({}, gaxGrpc.loadProto(path.join(__dirname, '..', '..', 'protos'), 'google/firestore/admin/v1/firestore_admin.proto'));
        ...
        const firestoreAdminStub = gaxGrpc.createStub(protos.google.firestore.admin.v1.FirestoreAdmin, opts);
